...
{
    scs_t string = scs_from_string ( "Hello", true );
...
TEST ( create_from_array, mustBeSuccess )
{
    ...
    scs_t ar = scs_from ( array, size, true );
...
TEST ( compare_cstrings, mustBeSuccess )
{
    ...
    const scs_t string = scs_from_string ( input, true );
...
TEST ( compare_length, mustBeSuccess )
{
    ...
    scs_t string2 = scs_from ( other, 10, true );
